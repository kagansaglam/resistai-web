          ...
          <div className="grid grid-cols-2 gap-6 mb-10">
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6">
              ...
              <ul className="space-y-3 text-sm text-emerald-800">
                ...
                <li className="flex items-start gap-3"><span className="text-emerald-500 mt-0.5 shrink-0">✓</span><span><strong>On-demand druggability</strong> — enter any UniProt ID and fpocket scores it live; AlphaFold gives a structure, ResistAI gives the druggable pockets</span></li>
      ...
      <section id="features" className="px-8 py-24 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-8">
          {[
            ...
            { icon: "🧬", title: "On-Demand fpocket", desc: "Any UniProt ID, scored live — fpocket runs on the AlphaFold structure in real time. No local install, no pipeline.", href: "/dashboard/analyse" },
